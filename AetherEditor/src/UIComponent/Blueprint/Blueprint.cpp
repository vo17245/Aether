...
//{
    ...
    Blueprint::Node* Blueprint::FindNode(ed::NodeId id)
    {
    ...
    Blueprint::Link* Blueprint::FindLink(ed::LinkId id)
    {
    ...
    Blueprint::Pin* Blueprint::FindPin(ed::PinId id)
    {
        if (!id)
            return nullptr;
    ...
    // void Blueprint::DrawItemRect(ImColor color, float expand = 0.0f)
    //{
    ...
    // void Blueprint::FillItemRect(ImColor color, float expand = 0.0f, float rounding = 0.0f)
    //{
    ...
    Blueprint::Node* Blueprint::SpawnInputActionNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnBranchNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnDoNNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnOutputActionNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnPrintStringNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnMessageNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnSetTimerNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnLessNode()
    {
        m_Nodes.emplace_back(GetNextId(), "<", ImColor(128, 195, 248));
        m_Nodes.back().Type = NodeType::Simple;
    ...
    Blueprint::Node* Blueprint::SpawnWeirdNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnTraceByChannelNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnTreeSequenceNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnTreeTaskNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnTreeTask2Node()
    {
    ...
    Blueprint::Node* Blueprint::SpawnComment()
    {
    ...
    Blueprint::Node* Blueprint::SpawnHoudiniTransformNode()
    {
    ...
    Blueprint::Node* Blueprint::SpawnHoudiniGroupNode()
    {
    ...
    void Blueprint::Init()
    {
        ...
        m_HeaderBackgroundDeviceImage =
            CreateScope<DeviceTexture>(Utils::LoadSrgbTexture("Asset/Blueprint/BlueprintBackground.png").value());
        m_SaveIconDeviceImage =
            CreateScope<DeviceTexture>(Utils::LoadSrgbTexture("Asset/Blueprint/ic_save_white_24dp.png").value());
        m_RestoreIconDeviceImage =
            CreateScope<DeviceTexture>(Utils::LoadSrgbTexture("Asset/Blueprint/ic_restore_white_24dp.png").value());
        m_HeaderBackgroundImage =
            CreateScope<ImGuiComponent::Image>(ImGuiComponent::Image::Create(*m_HeaderBackgroundDeviceImage).value());
        m_SaveIconImage =
            CreateScope<ImGuiComponent::Image>(ImGuiComponent::Image::Create(*m_SaveIconDeviceImage).value());
        m_RestoreIconImage =
            CreateScope<ImGuiComponent::Image>(ImGuiComponent::Image::Create(*m_RestoreIconDeviceImage).value());
    ...
    void Blueprint::ShowLeftPane(float paneWidth)
    {
        ...
        int saveIconWidth = m_SaveIconImage->GetSize().x;
        int saveIconHeight = m_SaveIconImage->GetSize().y;
        int restoreIconWidth = m_RestoreIconImage->GetSize().x;
        int restoreIconHeight = m_RestoreIconImage->GetSize().y;
        ...
        for (auto& node : m_Nodes)
        {
            ...
            auto iconPanelPos =
                start
                + ImVec2(paneWidth - ImGui::GetStyle().FramePadding.x - ImGui::GetStyle().IndentSpacing - saveIconWidth
    ...
    void Blueprint::Draw()
    {
        ...
        ed::Begin("Node editor");
        {
            ...
            for (auto& node : m_Nodes)
            {
                ...
                // drawList->AddRectFilled(inputsRect.GetTL() + ImVec2(0, 1), inputsRect.GetBR(),
                //     IM_COL32((int)(255 * pinBackground.x), (int)(255 * pinBackground.y), (int)(255 *
                //     pinBackground.z), inputAlpha), 4.0f, 12);
                // ImGui::PushStyleVar(ImGuiStyleVar_AntiAliasFringeScale, 1.0f);
                // drawList->AddRect(inputsRect.GetTL() + ImVec2(0, 1), inputsRect.GetBR(),
                //     IM_COL32((int)(255 * pinBackground.x), (int)(255 * pinBackground.y), (int)(255 *
                //     pinBackground.z), inputAlpha), 4.0f, 12);
                ...
                // drawList->AddRectFilled(outputsRect.GetTL(), outputsRect.GetBR() - ImVec2(0, 1),
                //     IM_COL32((int)(255 * pinBackground.x), (int)(255 * pinBackground.y), (int)(255 *
                //     pinBackground.z), outputAlpha), 4.0f, 3);
                ////ImGui::PushStyleVar(ImGuiStyleVar_AntiAliasFringeScale, 1.0f);
                // drawList->AddRect(outputsRect.GetTL(), outputsRect.GetBR() - ImVec2(0, 1),
                //     IM_COL32((int)(255 * pinBackground.x), (int)(255 * pinBackground.y), (int)(255 *
                //     pinBackground.z), outputAlpha), 4.0f, 3);
