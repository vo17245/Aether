...
namespace Utils
{
inline std::expected<DeviceTexture, std::string> LoadTexture(const std::string& path, PixelFormat format)
{
    // load image
...
inline std::expected<DeviceTexture, std::string> LoadLinearTexture(const std::string& path)
{
