...
using ImGui::NodeEditor::PinKind;
using ImGui::NodeEditor::StyleColor;
using ImGui::NodeEditor::StyleVar;
using ImGui::NodeEditor::SaveReasonFlags;

using ImGui::NodeEditor::NodeId;
using ImGui::NodeEditor::PinId;
using ImGui::NodeEditor::LinkId;
...
struct Style: ImGui::NodeEditor::Style
{
